...
| [2026-05-11 UI shell visual coherence](plans/2026-05-11-ui-shell-visual-coherence.md) | Implement the follow-on shell-wide visual-coherence work: shell surface foundation, deterministic fixture icons, command band, sidebar, status/operation, preview/details, and full-shell visual evidence. | active; M1-M3 closed; M3 visual evidence deferred to M8 | `implement` M4 |
