...
| [2026-05-11 UI shell visual coherence](plans/2026-05-11-ui-shell-visual-coherence.md) | Implement the follow-on shell-wide visual-coherence work: shell surface foundation, deterministic fixture icons, command band, sidebar, status/operation, preview/details, and optional visual-review artifacts. | active; M1-M7 closed; optional M8 not triggered; visual-evidence amendment approved; CR-005/CR-006/CR-007/CR-008/PR-002/TSR-001 resolved | `explain-change` |
