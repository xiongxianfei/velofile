...
| Plan | Scope | Status | Next step |
|---|---|---|---|
| [2026-05-16 test runtime optimization](plans/2026-05-16-test-runtime-optimization.md) | Split validation tiers, optimize corpus test runtime, preserve public script smoke and release evidence, and record runtime evidence. | active; M2 closed | `implement` M3 |
